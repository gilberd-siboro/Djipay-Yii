...
<body>
    <div class="min-h-screen bg-gradient-to-br from-gray-200 via-gray-600 to-gray-900">
        <main class="lg:pl-72">
            <div class="">
                <div class="px-4 py-10 sm:px-6 lg:px-8 lg:py-6">
                    <div class=" min-h-screen p-8">
                        ...
                        $imageUrl = Url::to('@web/image/homepage2.jpeg');
                        ?>
                        <div class="flex pr-10 bg-white rounded-lg" style="background-image: url('<?= $imageUrl ?>'); height: 100vh; background-size: cover; background-position: center;">
                        </div>
                    </div>
                </div>
            </div>
        </main>
        <aside class="fixed inset-y-0 hidden w-1/4 px-4 py-6 sm:px-6 lg:px-8 xl:block" style="max-height: calc(100vh - 40px); overflow-y: auto;">
            <div class=" mt-4 ml-4">
                <a aria-label="Home" href="/dashboard">
                    <svg aria-hidden="true" viewBox="0 0 109 40" class="h-16 w-auto">
            ...
            <h1 class=" text-3xl font-bold tracking-tight text-gray-900 justify-center items-center mt-40">Payroll management System Dashboard</h1>
        </aside>
